        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" name="serverdata" id="serverdata" action="{{ route('add_server')}}" method="post">
                <div class="card-body">
                ...
                <div class="card-footer">
                  <button type="submit" id="serveradd" class="btn btn-primary">Submit</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
         ...
         submitHandler:function(form){
                ...
                $.ajax({
                    ...
                    success: function(data) {
                          if(data!='false'){
                             toastr.info(data);
                             $("#serverdata").trigger('reset');
                             $(':input').val('');
                             $('#serveradd').text("Submit");
                             read_data();
                          }
                          else{
                            toastr.error('Please Try Again');
                          }
                          $("#serveradd").prop('disabled', false);
                    },
                });
            }
    });
